        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.axios.get("/api/task/".concat(_this.$route.params.id)).then(function (response) {
                  var _response$data = response.data,
                      title = _response$data.title,
                      Description = _response$data.Description,
                      estado = _response$data.estado;
                  _this.task.title = title, _this.task.Description = Description, _this.task.estado = estado;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this2.axios.put("/api/task/".concat(_this2.$route.params.id), _this2.task).then(function (response) {
                  _this2.$router.push({
                    name: "ShowTask"
                  });
                })["catch"](function (error) {
          ...
          _c(
            ...
            [
              _c("div", { staticClass: "row" }, [
                ...
                _vm._v(" "),
                _c("div", { staticClass: "col-12 mb-2" }, [
                  _c("label", { attrs: { for: "title" } }, [_vm._v("State: ")]),
                  _vm._v(" "),
                  _c(
                    "select",
                    {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.task.estado,
                          expression: "task.estado",
                        },
                      ],
                      on: {
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _c("option", { attrs: { value: "NO REALIZADO" } }, [
                        _vm._v("NO REALIZADO"),
                      ]),
                    ]
                  ),
